...
import com.marico.ncovreportsystem.mapper.TbHospitalMapper;
import com.marico.ncovreportsystem.mapper.TbReportMapper;
import com.marico.ncovreportsystem.mapper.TbSpecimenMapper;
...
import com.marico.ncovreportsystem.util.ExcelUtil;
import com.marico.ncovreportsystem.util.FileUtil;
import com.marico.ncovreportsystem.util.NumberUtil;
...
//		}
	...
	public PageResult list(TbSpecimen searchSpecimen, Integer pageNum, Integer pageSize, Integer sortRule) {
		...
		if(sortRule!=null) {
			if(sortRule.equals(1)) specimenExample.setOrderByClause("door_num");
			if(sortRule.equals(2)) specimenExample.setOrderByClause("recv_time");
			if(sortRule.equals(3)) specimenExample.setOrderByClause("create_time");
			if(sortRule.equals(4)) specimenExample.setOrderByClause("specimen_code");
			if(sortRule.equals(5)) specimenExample.setOrderByClause("test_type_id");
			if(sortRule.equals(6)) specimenExample.setOrderByClause("hos_id");
		}
	...
	public Result delete(Integer specimenId) {
		...
		if(specimen==null) return new Result(false, "删除失败,该样本不存在");
