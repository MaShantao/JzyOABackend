...
import com.marico.ncovreportsystem.util.PDFUtil;
import com.marico.ncovreportsystem.util.StringUtil;
...
public class ReportServiceImpl implements ReportService {
	...
	public Result batchSaveAsNegative(HttpServletRequest request, HttpServletResponse response,
			List<TbSpecimen> specimenList, int reporterId, int reviewerId, String hosName, String deptName,String createTime) {
	...
	public Map<String, Object> wrapReportPara(TbReport saveReport) {
		...
		textMap.put("patient_type",
				saveReport.getSpecimen().getPatientType() == null ? "" : saveReport.getSpecimen().getPatientType().getDictValue());
		...
		if ("ncov".equals(saveReport.getSpecimen().getTestType().getDictMark())) {
			...
			if(saveReport.getSpecimen().getSpecimenType()!=null&&saveReport.getSpecimen().getSpecimenType().getDictMark()!=null) {
