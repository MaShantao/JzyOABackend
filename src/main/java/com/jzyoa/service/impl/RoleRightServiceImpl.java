...
import com.jzyoa.mapper.TbRoleRightMapper;
import com.jzyoa.pojo.TbRoleRight;
import com.jzyoa.pojo.TbRoleRightExample;
import com.jzyoa.pojo.TbRoleRightExample.Criteria;
...
public class RoleRightServiceImpl implements RoleRightService {
	...
	public Result batchSave(Integer roleId, List<Integer> rightList) {
		if (roleId == null || rightList == null || rightList.size() == 0)
			return new Result(false, "角色权限保存失败，数据格式出错");
